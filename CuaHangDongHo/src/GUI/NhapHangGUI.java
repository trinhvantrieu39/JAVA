...
public class NhapHangGUI extends JPanel{
	...
	private void them(MouseEvent me) {
		...
		if(i>=0) {
			...
			float gia =Float.parseFloat(dongia.getText());
			...
			SanPham sanpham= new SanPham(masp,tensp,maloai,sluong,gia,hinhanh);
